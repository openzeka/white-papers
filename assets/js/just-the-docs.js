...
function searchLoaded(index, docs) {
  ...
  function update() {
    ...
    if (results.length == 0) {
      ...
      noResultsDiv.innerText = (window.JTD_I18N && window.JTD_I18N.search_no_results) || 'No results found';
...
jtd.onReady(function(){
  ...
  codeBlocks.forEach(codeBlock => {
    ...
    copyButton.ariaLabel = (window.JTD_I18N && window.JTD_I18N.copy_code) || 'Copy code to clipboard';
