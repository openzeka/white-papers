...
description: >-
  Switch-based AI cluster setup with 8 NVIDIA DGX Spark nodes:
...
<a class="product-card-btn" href="https://openzeka.com/en/product/nvidia-dgx-spark-8-node-ai-cluster-8-node/">Purchase This Product →</a>
</div>
</div>
