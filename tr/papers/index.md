...
| [LLM Çıkarım Benchmark Tablosu]({{ '/llm-inference-benchmarks/' | relative_url }}) | Etkileşimli benchmark tablosu: cihaz, model ve kuantizasyona göre filtreleyin, kendi hizmet seviyesi eşiklerinizi girin | DGX Spark (GB10), DGX B300, RTX PRO 6000, Jetson Thor |
